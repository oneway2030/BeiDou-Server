...
INSERT INTO `game_config` ( `config_type`, `config_sub_type`, `config_clazz`, `config_code`, `config_value`, `config_desc`)
VALUES ( 'server', 'Game Mechanics', 'java.lang.Integer', 'max_accounts_per_ip_or_mac', '-1', 'max_accounts_per_ip_or_mac');
...
-- 添加每次转生后装备升级次数
INSERT INTO `game_config` ( `config_type`, `config_sub_type`, `config_clazz`, `config_code`, `config_value`, `config_desc`)
VALUES ( 'server', 'Game Mechanics', 'java.lang.Integer', 'each_time_reborn_equipment_add_level_up', '0', 'each_time_reborn_equipment_add_level_up');
