...
public class Fishing {
    ...
    public static int getRandomItem() {
        ...
        int[] rares = {1002859, 1002553, 1002762, 1002763, 1002764, 1002765, 1002766, 1002663, 1002788, 1002949, 2049100, 2340000, 2340001, 2040822, 2040822, 2040822, 2040822}; // filler' uplast
