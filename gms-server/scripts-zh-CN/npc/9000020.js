...
function start(){
    if(currentMapID === null) {
        ...
        addTravelMap('东方神州','台湾西门町',740000000,4,10000,[
            '想回到20年前的宝岛台湾吗？想和当年大红大紫的港台大明星们亲密接触吗？',
            '想的话就去台湾西门町转转吧，逛完记得再去#b不夜城#k的夜市逛逛哦。'
        ]);


        addTravelMap('东方神州','台湾１０１大厦',742000000,4,10000,[
            '你是不是每次逛完废都广场都觉得意犹未尽呢？',
            '那我推荐你去一个更高级的商业中心，#b台湾101大厦#k，近期已经开放！欢迎在那里购物！'
        ]);
        ...
        addTravelMap('泰国','水上市场',500000000,4,10000,[
            '泰国的水上市场是一个旅游胜地...',
            '在那里你还可以乘坐车辆前往金碧辉煌的#b黄金寺庙#k，领略佛家风情。'
        ]);

        addTravelMap('泰国','黄金寺庙',501000000,4,10000,[
            '泰国有一座金碧辉煌的#b黄金寺庙#k，可以尽情领略佛家风情...',
            '从泰国水上市场乘坐车辆就可以前往，不过我也可以直接送你过去。'
        ]);
...
function levelComback(index) {
	...
	if (fromMapID == -1 || fromMapID == null)  fromMapID = 100000000;
