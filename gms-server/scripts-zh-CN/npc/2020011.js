    ...
    if (actionx["Mental"]) {
        if (status == 0) {
            ...
            if (cm.getPlayer().getRemainingSp() > 0) {
                if (cm.getPlayer().getRemainingSp() > ((cm.getLevel() - 70) * 3 + 10)) {
            ...
            if (Math.floor(cm.getJobId() / 10) == 41) {
                cm.sendNext("你已经正式被任命为#b无影人#k。这本技能书为无影人引入了一系列新的攻击技能，利用影子进行复制和替代，包括#b金钱攻击#k（用金币代替MP，并根据投掷的金币数量对怪物造成伤害）和#b影分身#k（创建一个模仿每一个动作的影子，使无影人能够像两个隐士一样攻击怪物）。利用这些技能来对抗以前可能难以征服的怪物。");
            } else {
            ...
            cm.sendNextPrev("我也给了你一些技能点和能力值；这应该能让你开始了。你现在确实成为了一个强大的飞侠。不过要记住，现实世界将等待着你，那里会有更艰难的障碍需要克服。当你觉得自己无法训练自己达到更高的境界时，那时候，只有那时候，来找我。我会在这里等着。");
        }
        ...
        if (sel == 0) {
            if (cm.getPlayer().getLevel() >= 70 && cm.getJobId() % 10 == 0) {
                if (status == 0) {
                    cm.sendYesNo("欢迎。我是#b#p2020011##k，所有飞侠的首领，愿意分享我的街头知识和艰难生活给那些愿意倾听的人。你似乎已经准备好迈出这一步，准备好迎接第三职业转职的挑战。太多的飞侠来来去去，无法达到第三职业转职的标准。你呢？你准备好接受考验，进行第三职业转职了吗？");
                } else if (status == 1) {
                    cm.getPlayer().setPartyQuestItemObtained("JB3");
                    cm.sendNext("好的。你将接受飞侠的两个重要方面的测试：力量和智慧。我现在会向你解释测试的物理部分。还记得在废弃都市的#b#p1052001##k吗？去找他，他会告诉你测试的第一部分的细节。请完成任务，并从#p1052001#那里得到#b#t4031057##k。");
                } else if (status == 2) {
